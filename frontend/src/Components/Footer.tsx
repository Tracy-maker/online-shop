...
type ModalType = "PrivacyPolicy" | "TermsOfService" | "ReturnPolicy" | "Disclaimer" | null;
    ...
    <footer className="flex flex-col items-center gap-8 p-6 sm:p-10 bg-gray-800 text-white">
      ...
      <div className="w-full flex flex-col items-center gap-4 mt-6">
        ...
        <p className="text-xs sm:text-sm text-gray-400 text-center">
          © {new Date().getFullYear()} Rimberio Online Solution. All Rights Reserved.
        </p>
      ...
      {/* Modals */}
      {activeModal === "PrivacyPolicy" && <PrivacyPolicy onClose={closeModal} />}
      {activeModal === "TermsOfService" && <TermsOfService onClose={closeModal} />}
